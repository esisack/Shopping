...
public class ItemTypeConverter implements Converter {
    ...
    @EJB
    private ItemTypeFacade ejbFacade;
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
        ...
        if (object instanceof ItemType) {
            ...
            return getStringKey(o.getItemTypeId());
        } else {
            Logger.getLogger(this.getClass().getName()).log(Level.SEVERE, "object {0} is of type {1}; expected type: {2}", new Object[]{object, object.getClass().getName(), ItemType.class.getName()});
            return null;
        }
    }
